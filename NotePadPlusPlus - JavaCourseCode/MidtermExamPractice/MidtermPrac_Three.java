...
public class MidtermPrac_Three {
	public static void main(String[] args){
		...
		*/
		...
		/* ### === Start the code here === ### */
			...
			/* === Set the variables and show the hello message ===*/
		
			Scanner scn = new Scanner(System.in);
			Random rdm = new Random();
		
			int[] userInput = new int[7]; // Initialize the array to store up to 7 guesses
			int randomNum = rdm.nextInt(100)+1;
			
			String[] gameHistoryElement = {"Attempt", "Guess", "Feedback"};
			String[][] gameHistoryContent = new String[6][3]; // A method to create an empty array.
			...
			/* === Attempt the user to input guess value with using the loop. Also check the answer and response  ===*/
				...
				for (int i = 0; i < 6; i++) {  // Loop for a maximum of 6 attempts
					...
					gameHistoryContent[i][0] = String.valueOf(i + 1);  // Save the attempt number (1 to 6)
